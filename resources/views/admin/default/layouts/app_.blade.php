...
<head>
    ...
    <link href="{{ asset('admin/default/css/shards-dashboards.1.1.0.min.css') }}" rel="stylesheet">
                ...
                <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
                    ...
                    <ul class="navbar-nav flex-row">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" style="margin-right:5px;">
                                <span class="d-none d-md-inline-block" style="margin-left:20px;margin-right:20px;"><h4>홍길동</h4></span>
                            </a>
...
<script src="{{ asset('admin/default/js/extras.1.1.0.min.js') }}"></script>
<script src="{{ asset('admin/default/js/shards-dashboards.1.1.0.min.js') }}"></script>
