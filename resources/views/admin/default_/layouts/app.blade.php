...
<head>
    ...
    <link href="{{ asset('admin/default/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('admin/default/css/materialdesignicons.min.css') }}" rel="stylesheet">
</head>
                        ...
                        <div class="dropdown-body">
                            <div class="dropdown-list">
                                <div class="image-wrapper">
                                    <img class="profile-img" src="/admin/default/images/profile/male/image_1.png" alt="profile image">
                            ...
                            <div class="dropdown-list">
                                <div class="image-wrapper">
                                    <img class="profile-img" src="/admin/default/images/profile/female/image_2.png" alt="profile image">
                                    <div class="status-indicator rounded-indicator bg-success"></div>
                                </div>
                                <div class="content-wrapper">
                            ...
                            <div class="dropdown-list">
                                <div class="image-wrapper">
                                    <img class="profile-img" src="/admin/default/images/profile/male/image_3.png" alt="profile image">
    ...
    <div class="sidebar">
        <div class="user-profile">
            <div class="display-avatar animated-avatar">
                <img class="profile-img img-lg rounded-circle" src="/admin/default/images/profile/male/image_1.png" alt="profile image">
            </div>
                                ...
                                <div class="wrapper">
                                    <div class="d-flex justify-content-between">
                                        <div class="split-header">
                                            <img class="img-ss mt-1 mb-1 mr-2" src="/admin/default/images/social-icons/instagram.svg" alt="instagram">
                        ...
                        <div class="grid">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-sm">
                                    ...
                                    <tr>
                                        <td class="pr-0 pl-4">
                                            <img class="profile-img img-sm" src="/admin/default/images/profile/male/image_4.png" alt="profile image">
                                        </td>
                                        <td class="pl-md-0">
                              ...
                              <span class="status-indicator rounded-indicator small bg-primary"></span>Account Deactivated </span>
                                    ...
                                    <tr>
                                        <td class="pr-0 pl-4">
                                            <img class="profile-img img-sm" src="/admin/default/images/profile/male/image_3.png" alt="profile image">
                                        </td>
                                        <td class="pl-md-0">
                              ...
                              <span class="status-indicator rounded-indicator small bg-success"></span>Email Verified </span>
                                    ...
                                    <tr>
                                        <td class="pr-0 pl-4">
                                            <img class="profile-img img-sm" src="/admin/default/images/profile/female/image_2.png" alt="profile image">
                                        </td>
                                        <td class="pl-md-0">
                              ...
                              <span class="status-indicator rounded-indicator small bg-warning"></span>Payment On Hold </span>
                                    ...
                                    <tr>
                                        <td class="pr-0 pl-4">
                                            <img class="profile-img img-sm" src="/admin/default/images/profile/male/image_10.png" alt="profile image">
                                        </td>
                                        <td class="pl-md-0">
                                    ...
                                    <div class="timeline-vertical dashboard-timeline">
                                        ...
                                        <div class="activity-log">
                                            ...
                                            <div class="log-details">Report has been updated <div class="grouped-images mt-2">
                                                    <img class="img-sm" src="/admin/default/images/profile/male/image_4.png" alt="Profile Image" data-toggle="tooltip" title="Gerald Pierce">
                                                    <img class="img-sm" src="/admin/default/images/profile/male/image_5.png" alt="Profile Image" data-toggle="tooltip" title="Edward Wilson">
                                                    <img class="img-sm" src="/admin/default/images/profile/female/image_6.png" alt="Profile Image" data-toggle="tooltip" title="Billy Williams">
                                                    <img class="img-sm" src="/admin/default/images/profile/male/image_6.png" alt="Profile Image" data-toggle="tooltip" title="Lelia Hampton">
...
<!-- plugins:js -->
<script src="/admin/default/js/core.js"></script>
<!-- endinject -->
<!-- build:js -->
<script src="/admin/default/js/template.js"></script>
<script src="/admin/default/js/dashboard.js"></script>
<!-- endbuild -->
</body>
</html>
